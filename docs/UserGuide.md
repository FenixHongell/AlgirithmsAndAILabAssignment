...
- Git
- Windows 10/11, (untested on MacOs & Linux)
- IDE: Visual Studio 2022 or JetBrains Rider 2025.1.6

## How to run (Play in Editor)
1. Clone the project
    - Using Git:
      ```bash
      git clone https://github.com/FenixHongell/AlgirithmsAndAILabAssignment.git
      ```
