This week I finished Room generation, implemented graph generation and implemented testing for the graph generation.
...
|-------|------------|-----------------------------------------|
| 30.1. | 3h         | Room generation + general experimenting |
| 31.1  | 6h         | Graph generation, research & tests      |
| Total | 9h         |                                         |
